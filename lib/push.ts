...
/** Send a push notification to all subscribers, optionally skipping one player (e.g. the sender). */
export async function sendPushToAll(
  ...
  let query = db().from('push_subscriptions').select('endpoint, p256dh, auth, player_id');
